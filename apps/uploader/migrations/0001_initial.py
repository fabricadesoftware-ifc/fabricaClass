...
import apps.uploader.models.document
import apps.uploader.models.image
import uuid
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(
                        upload_to=apps.uploader.models.document.document_file_path
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.ImageField(
                        upload_to=apps.uploader.models.image.image_file_path
                    ),
                ),
                ("description", models.CharField(blank=True, max_length=255)),
                ("uploaded_on", models.DateTimeField(auto_now_add=True)),
